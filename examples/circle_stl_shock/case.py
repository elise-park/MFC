...
case = {
    ...
    "patch_icpp(3)%model_filepath": "Circle_IBM.stl",
    "patch_icpp(3)%alter_patch(1)": "T",
    "patch_icpp(3)%alter_patch(2)": "F", # originally T
    "patch_icpp(3)%model_translate(1)": -0.15,
    "patch_icpp(3)%model_translate(2)": -0.15,
    ...
    "patch_icpp(3)%alpha_rho(1)": 0.0, #0.0 for liquid
    "patch_icpp(3)%alpha(1)": 0.0,#0.0 for liquid
    "patch_icpp(3)%alpha_rho(2)": rhol, #rhol for liquid
    "patch_icpp(3)%alpha(2)": 1.0, #1.0 for liquid
