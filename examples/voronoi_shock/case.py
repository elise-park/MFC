    ...
    json.dumps(
        {
            ...
            "patch_icpp(2)%x_centroid": -0.625, # -3 * leng / 8.0,
            ...
            #"patch_icpp(3)%model_translate(1)":1.25, #1.5
            #"patch_icpp(3)%model_translate(2)":0.00,   
            #"patch_icpp(3)%model_threshold": 0.99,
            #"patch_icpp(3)%x_centroid": 0.0e00, #0.0
            ...
            "patch_icpp(3)%pres": patmos,
            "patch_icpp(3)%alpha_rho(1)": rhol * alphal_lung,
            "patch_icpp(3)%alpha_rho(2)": rhog * alphag_lung, #gas
            "patch_icpp(3)%alpha(1)": alphal_lung,
            "patch_icpp(3)%alpha(2)": alphag_lung,
