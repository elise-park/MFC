    ...
    json.dumps(
        {
            ...
            "patch_icpp(1)%alpha_rho(1)": 1.29,#water
            ...
            "patch_icpp(2)%alpha_rho(1)": 2.4, #shocked water
            ...
            "patch_icpp(3)%model_spc": 100,
            "patch_icpp(3)%model_scale(1)": 4,
            "patch_icpp(3)%model_scale(2)": 4, 
            "patch_icpp(3)%model_translate(1)":0.25,#0.25
            ...
            "patch_icpp(3)%alpha_rho(1)": 1.29,#water
            ...
            "patch_icpp(4)%alpha_rho(2)": 0.167, #gas
